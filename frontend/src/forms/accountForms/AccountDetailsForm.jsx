    ...
    return (
        <form onSubmit={submitFunc}>
            <fieldset>
                ...
                <input type="text" id="username" name="username" onChange={(e) => setFormFunc({...form, username: e.target.value})} required autoFocus />
                <br />
                ...
                <input type="text" id="account-theme" name="account-theme" value='default' required disabled />
            </fieldset>
...

            {
                registerAccount ? (
                    <fieldset id="set-password" name="Set Password">
                        ...
                        <input type="password" id="create-password" name="create-password" onChange={(e) => updatePassword(e.target.value)} required />
                        <br />
                        ...
                        {
                            createPassword !== form.password && <p>Password fields do not match.</p>
                        }
                    </fieldset>
                ) : (
